...
(* Then use: STRONG_EQUIV_IS_STRONG_BISIM to prove that STRONG_EQUIV is maximal *)

(*
val STRONG_EQUIV_IS_MAXIMAL = store_thm (
   "STRONG_EQUIV_IS_MAXIMAL", ``!Bsm. STRONG_BISIM Bsm ==> Bsm RSUBSET STRONG_EQUIV``,
    GEN_TAC
 >> REWRITE_TAC [RSUBSET]
 >> 
*)
