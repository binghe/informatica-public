...
val STRONG_BISIM_UPTO_LEMMA = store_thm (
 ...
 >| [ (* goal 1 (of 2) *)
	...
	(STRIP_ASSUME_TAC o (ONCE_REWRITE_RULE [PROPERTY_STAR])) \\
      POP_ASSUM (STRIP_ASSUME_TAC o (Q.SPEC `u`)) \\
      POP_ASSUM K_TAC \\
      POP_ASSUM (STRIP_ASSUME_TAC o (fn th => MATCH_MP th (ASSUME ``TRANS y u E2'``))) \\
(***
   E    ~   y'    Bsm    y    ~   E'
   |       /              \       |
   u      u                u      u
 ...
 ***)
	...
	(STRIP_ASSUME_TAC o (ONCE_REWRITE_RULE [PROPERTY_STAR])) \\
      ...
      POP_ASSUM (STRIP_ASSUME_TAC o (fn th => MATCH_MP th (ASSUME ``TRANS y' u E1'``))) \\
(***
   E    ~     y'     Bsm    y   ~   E'
   |         /               \      |
   u        u                 u     u
...
val STRONG_BISIM_UPTO_EQUIV = store_thm (
 ...
 >> IMP_RES_TAC STRONG_BISIM_SUBSET_EQUIV
...
(* One-hole context is already defined in CoarsestCongrTheory *)
...
val [WG1, WG2, WG3, WG4, WG5, WG6, WG7] =
    map save_thm
        (combine (["WG1", "WG2", "WG3", "WG4", "WG5", "WG6", "WG7"], CONJUNCTS WG_rules));
...
val STRONG_UNIQUE_SOLUTIONS_LEMMA = store_thm (
  ...
  ``!E. WG E ==> !P a P'. TRANS (E P) a P' ==>
		 ?E'. EXPR E' /\ (P' = E' P) /\ !Q. TRANS (E Q) a (E' Q)``,
    Induct_on `WG` >> BETA_TAC
 >> COUNT_TAC (rpt STRIP_TAC) (* 7 sub-goals here *)
 >| [ (* goal 1 (of 7) *)
 ...
 >| [ (* goal 1 (of 14) *)
	...
	(STRIP_ASSUME_TAC o (ONCE_REWRITE_RULE [PROPERTY_STAR])) \\
      ...
      [ (* goal 9.1 (of 3) *)
        ...
        [ (* goal 9.3.1 (of 4) *)
          Q.EXISTS_TAC `y || y''` \\
          REVERSE CONJ_TAC >- ( MATCH_MP_TAC STRONG_EQUIV_PRESD_BY_PAR >> ASM_REWRITE_TAC [] ) \\
          Q.EXISTS_TAC `y || y''` \\
      ...
      [ (* goal 11.1 (of 2) *)
        ...
        [ (* goal 11.1.1 (of 2) *)
          ...
          REVERSE CONJ_TAC >- ( MATCH_MP_TAC STRONG_EQUIV_SUBST_RESTR >> ASM_REWRITE_TAC [] ) \\
          Q.EXISTS_TAC `restr L y` \\
          CONJ_TAC >- ( MATCH_MP_TAC STRONG_EQUIV_SUBST_RESTR >> ASM_REWRITE_TAC [] ) \\
          DISJ1_TAC >> REWRITE_TAC [],
          (* goal 11.1.2 (of 2) *)
      ...
      [ (* goal 13.1 (of 2) *)
        ...
        REVERSE CONJ_TAC >- ( MATCH_MP_TAC STRONG_EQUIV_SUBST_RELAB >> ASM_REWRITE_TAC [] ) \\
        Q.EXISTS_TAC `relab y rf` \\
